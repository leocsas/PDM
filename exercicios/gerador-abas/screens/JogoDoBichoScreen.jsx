...
export default function JogoDoBichoScreen() {
  ...
  return (
    <View style={styles.container}>
      <Button mode="contained" onPress={gerarAnimal} style={styles.button}>
        Gerar Animal
      </Button>
      {animalGerado && (
        <>
...
const styles = StyleSheet.create({
  ...
  button: { backgroundColor: 'red', marginBottom: 20 },
  nome: { fontSize: 24, fontWeight: 'bold', marginBottom: 10 },
  imagem: { width: 200, height: 200, resizeMode: 'cover', borderRadius: 10 },
});
